...
kernels  = ["cosine_naive\n(baseline)", "cosine_tiled\n(shared memory)", "cosine_warp\n(warp shuffle)"]
...
bar_w = 0.52
bars = ax.bar(x, times, width=bar_w, color=colours, zorder=3,
...
ax.legend(handles=patches, loc="upper right",
          facecolor="#1a1d26", edgecolor="#2a2d38",
          labelcolor="#c8ccd8", fontsize=9.5, framealpha=0.9,
          handlelength=1.2, handleheight=1.1, borderpad=0.8)

# Throughput callout bottom-right
fig.text(
    0.96, 0.04,
    "553M pairs/sec  ·  full pipeline ~12 ms",
    ha="right", color="#27ae60", fontsize=9.5, fontstyle="italic",
)
